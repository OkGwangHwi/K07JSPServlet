...
<body>
	...
	하지만 EL에서는 null을 0으로 간주하여 계산한다. 따라서
	...
	*/
	...
	만약 해당페이지?myNumber=20인 경우 결과 30 출력됨
	...
	*/
	...
	<!--  
	Tomcat8.0부터는 EL에서 변수할당이 가능해졌다. 하지만 개발시에는 실제
	서비스할 웹서버의 버전을 확인후 사용여부를 결정한다.
	...
	null이거나 ""(빈문자열)일때
		...
		true를 반환하는 연산자이다.
	-->
	<h3>EL의 empty연산자 : null 일때 true를 반환하는 연산자</h3>
	<%
	String nullStr = null;
	String emptyStr = "";
