...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    -어플리케이션 영역에 저장된 속성은 모든 JSP(Servlet)페이지에서
    	공유된다.
    -링크를 통해 새로운 페이지에 대한 요청이나,포워드,인클루드 등 모든 페이지에서 영역이
    	공유된다. 이런 페이지들은 하나의 웹어플리케이션내에
    	존재하기 때문이다.
    */
    //현재날짜 가져오기
    ...
    //리스트계열의 컬렉션에 DTO객체 저장(ArrayList와 사용법은 동일함)
...
<body>
	...
	<!-- 
		외부파일 인클루드 : include 지시어를 통해 페이지를 삽입하면
						파일의 내용이 그대로 포함된 후 컴파일되므로
						하나의 페이지라 간주하면 된다. 그러므로
						page영역,request영역이 공유된다.
	-->
